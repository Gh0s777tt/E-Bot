...
| **`levelInfo` — kap poziomu 1000 łamie `xpInto < xpFor`** | `leveling.mts:108` | Osiągalne tylko przez `/xp give` (admin, addytywny bez kapu sumy, ~169× maks). Pasek `/rank` > 100%. Realne dopiero przy nadużyciu uprawnień. | Uwaga / Defekt **Niski** |
