...
export const COMMAND_DESC: Record<Locale, Record<string, string>> = {
  pl: {
    ...
    link: 'Połącz konto Discord z profilem E-Forge.',
    portal: 'Portal E-Forge + jak zarabiać Ghost Tokens na Discordzie.',
    ...
    modai: 'AI co-pilot moderacji (streszczenie + sugestia akcji).',
    wishlist: 'Lista życzeń gier (z panelu).',
    battlepass: 'Twój sezonowy battle-pass (postęp wg aktywności).',
    pricealert: 'Osobiste alerty cenowe gier (DM przy spadku).',
  ...
  en: {
    ...
    link: 'Link your Discord account with your E-Forge profile.',
    portal: 'E-Forge portal + how to earn Ghost Tokens on Discord.',
    ...
    modai: 'AI moderation co-pilot (summary + suggested action).',
    wishlist: 'Game wishlist (from the dashboard).',
    battlepass: 'Your seasonal battle pass (activity progress).',
    pricealert: 'Personal game price alerts (DM on price drop).',
  ...
  de: {
    ...
    link: 'Verknüpfe dein Discord-Konto mit deinem E-Forge-Profil.',
    portal: 'E-Forge-Portal + wie man Ghost Tokens auf Discord verdient.',
    ...
    modai: 'KI-Moderations-Copilot (Zusammenfassung + Aktionsvorschlag).',
    wishlist: 'Spiele-Wunschliste (aus dem Dashboard).',
    battlepass: 'Dein saisonaler Battle-Pass (Aktivitätsfortschritt).',
    pricealert: 'Persönliche Spielpreis-Alarme (DM bei Preissturz).',
  ...
  es: {
    ...
    link: 'Vincula tu cuenta de Discord con tu perfil de E-Forge.',
    portal: 'Portal E-Forge + cómo ganar Ghost Tokens en Discord.',
    ...
    modai: 'Copiloto de moderación con IA (resumen + acción sugerida).',
    wishlist: 'Lista de deseos de juegos (desde el panel).',
    battlepass: 'Tu pase de batalla de temporada (progreso por actividad).',
    pricealert: 'Alertas de precio de juegos (DM al bajar el precio).',
  ...
  it: {
    ...
    link: 'Collega il tuo account Discord al profilo E-Forge.',
    portal: 'Portale E-Forge + come guadagnare Ghost Tokens su Discord.',
    ...
    modai: 'Copilota di moderazione IA (riepilogo + azione suggerita).',
    wishlist: 'Lista dei desideri dei giochi (dal pannello).',
    battlepass: 'Il tuo battle pass stagionale (progresso per attività).',
    pricealert: 'Avvisi prezzo giochi personali (DM al calo di prezzo).',
  ...
  fr: {
    ...
    link: 'Lie ton compte Discord à ton profil E-Forge.',
    portal: 'Portail E-Forge + comment gagner des Ghost Tokens sur Discord.',
    ...
    modai: 'Copilote de modération IA (résumé + action suggérée).',
    wishlist: 'Liste de souhaits de jeux (depuis le panel).',
    battlepass: 'Ton battle pass saisonnier (progression par activité).',
    pricealert: 'Alertes de prix de jeux (DM à la baisse de prix).',
  ...
  pt: {
    ...
    link: 'Vincule sua conta do Discord ao seu perfil E-Forge.',
    portal: 'Portal E-Forge + como ganhar Ghost Tokens no Discord.',
    ...
    modai: 'Copiloto de moderação com IA (resumo + ação sugerida).',
    wishlist: 'Lista de desejos de jogos (do painel).',
    battlepass: 'O teu passe de batalha sazonal (progresso por atividade).',
    pricealert: 'Alertas de preço de jogos (DM quando o preço cair).',
  ...
  zh: {
    ...
    link: '将 Discord 账号与你的 E-Forge 资料绑定。',
    portal: 'E-Forge 门户＋如何在 Discord 上赚取 Ghost Tokens。',
    ticket: '客服工单系统。',
    ...
    modai: 'AI 审核副驾驶（摘要 + 建议操作）。',
    wishlist: '游戏愿望单（来自后台）。',
    battlepass: '你的赛季通行证（按活跃度进度）。',
    pricealert: '个人游戏降价提醒（降价时私信）。',
    rank: '你的等级卡（XP／等级）。',
  ...
  ko: {
    ...
    link: 'Discord 계정을 E-Forge 프로필과 연동합니다.',
    portal: 'E-Forge 포털 + Discord에서 Ghost Tokens 버는 법.',
    ticket: '지원 티켓 시스템.',
    ...
    modai: 'AI 모더레이션 코파일럿(요약 + 권장 조치).',
    wishlist: '게임 위시리스트(대시보드에서).',
    battlepass: '시즌 배틀패스(활동 진행도).',
    pricealert: '개인 게임 가격 알림(가격 하락 시 DM).',
    rank: '내 랭크 카드(XP/레벨).',
  ...
  ru: {
    ...
    link: 'Привяжи аккаунт Discord к своему профилю E-Forge.',
    portal: 'Портал E-Forge + как зарабатывать Ghost Tokens в Discord.',
    ...
    modai: 'AI-помощник модерации (сводка + рекомендуемое действие).',
    wishlist: 'Список желаемых игр (из панели).',
    battlepass: 'Твой сезонный боевой пропуск (прогресс по активности).',
    pricealert: 'Личные оповещения о ценах на игры (ЛС при снижении).',
  ...
  uk: {
    ...
    link: "Прив'яжи акаунт Discord до свого профілю E-Forge.",
    portal: 'Портал E-Forge + як заробляти Ghost Tokens у Discord.',
    ...
    modai: 'AI-помічник модерації (зведення + рекомендована дія).',
    wishlist: 'Список бажаних ігор (з панелі).',
    battlepass: 'Твій сезонний бойовий пропуск (прогрес за активністю).',
    pricealert: 'Особисті цінові сповіщення на ігри (DM при зниженні).',
  ...
  ja: {
    ...
    link: 'Discord アカウントを E-Forge プロフィールと連携。',
    portal: 'E-Forge ポータル＋Discord で Ghost Tokens を稼ぐ方法。',
    ticket: 'サポートチケットシステム。',
    ...
    modai: 'AIモデレーション副操縦士（要約＋推奨アクション）。',
    wishlist: 'ゲームのウィッシュリスト（管理画面から）。',
    battlepass: 'シーズンのバトルパス（活動の進捗）。',
    pricealert: '個人ゲーム価格アラート（値下げ時にDM）。',
  ...
  ar: {
    ...
    link: 'اربط حساب Discord بملفك في E-Forge.',
    portal: 'بوابة E-Forge وكيفية ربح Ghost Tokens على Discord.',
    ...
    modai: 'مساعد إشراف بالذكاء الاصطناعي (ملخص + إجراء مقترح).',
    wishlist: 'قائمة أمنيات الألعاب (من اللوحة).',
    battlepass: 'تذكرة معركتك الموسمية (تقدم حسب النشاط).',
    pricealert: 'تنبيهات أسعار الألعاب الشخصية (رسالة خاصة عند انخفاض السعر).',
  ...
  id: {
    ...
    link: 'Tautkan akun Discord dengan profil E-Forge kamu.',
    portal: 'Portal E-Forge + cara dapat Ghost Tokens di Discord.',
    ...
    modai: 'Kopilot moderasi AI (ringkasan + tindakan disarankan).',
    wishlist: 'Wishlist game (dari dasbor).',
    battlepass: 'Battle pass musiman kamu (progres berdasarkan aktivitas).',
    pricealert: 'Peringatan harga game pribadi (DM saat harga turun).',
...
const INFO_DESC: Record<Locale, Record<string, string>> = {
  pl: {
    ...
    emoji: 'Dodaj/„ukradnij" emoji na serwer (z emoji, URL-a lub pliku).',
  ...
  en: {
    ...
    emoji: 'Add/"steal" an emoji to the server (from an emoji, URL, or file).',
    userinfo: 'User info (account, roles, boost).',
    serverinfo: 'Server info (members, channels, boosts).',
  },
  de: {
    avatar: 'Avatar eines Nutzers anzeigen.',
    emoji: 'Emoji zum Server hinzufügen/„stehlen" (aus Emoji, URL oder Datei).',
  ...
  es: {
    ...
    emoji: 'Añade/«roba» un emoji al servidor (de un emoji, URL o archivo).',
  ...
  it: {
    ...
    emoji: 'Aggiungi/«ruba» un emoji al server (da emoji, URL o file).',
  ...
  fr: {
    ...
    emoji: 'Ajoute/« vole » un emoji au serveur (depuis un emoji, une URL ou un fichier).',
  ...
  id: {
    ...
    emoji: 'Tambah/"curi" emoji ke server (dari emoji, URL, atau file).',
