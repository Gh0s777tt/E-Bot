...
if (process.env.RUMBLE_LIVESTREAM_API_URL) results.push(await getRumbleLive(process.env.RUMBLE_LIVESTREAM_API_URL));
if (process.env.YOUTUBE_LIVE_CHANNEL_ID) results.push(await getYouTubeLive(process.env.YOUTUBE_LIVE_CHANNEL_ID));
