<!-- SYNC: v0.248.0 · #318 · 2026-06-19 — utrzymywane przez `pnpm docs:check` (badge wersji + blurb „Najnowsze") -->
<!-- ╔══════════════════════════════════════════════════════════════════╗ -->
<!-- ║                            E - B O T                              ║ -->
<!-- ╚══════════════════════════════════════════════════════════════════╝ -->
...
Najnowsze: **v0.248.0** — 🌍🏁 **i18n UI panelu UKOŃCZONE** (38/38 stron × 14 języków) — ostatnia strona `/setup`. Wcześniej: `/settings`, `/moderation`, `/custom-commands`, `/engagement`, `/ai`, `/applications`, `/commands`, `/roles`, `/creator`, `/gaming`, i18n treści „Jak to działa?" (37/37), web GameVault (+RTL), Architekt serwera, config per‑serwer (Etap K) oraz 14 epików „2.0" (Faza 8).
