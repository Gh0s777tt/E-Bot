<!-- SYNC: v0.245.0 · #315 · 2026-06-19 — utrzymywane przez `pnpm docs:check` (badge wersji + blurb „Najnowsze") -->
<!-- ╔══════════════════════════════════════════════════════════════════╗ -->
<!-- ║                            E - B O T                              ║ -->
<!-- ╚══════════════════════════════════════════════════════════════════╝ -->
...
Najnowsze: **v0.245.0** — 🌍 i18n UI panelu — strona `/custom-commands` (14 języków). Wcześniej: `/engagement`, `/ai`, `/applications`, `/commands`, `/roles`, `/creator`, `/gaming`, `/integrations`, `/library`, `/eco`, `/economy`, `/donations`, `/profile`, `/stats`, i18n treści „Jak to działa?" (37/37), web GameVault (+RTL), Architekt serwera, config per‑serwer (Etap K) oraz 14 epików „2.0" (Faza 8).
