...
const COMMANDS = [
  ...
  {
    name: '/library [szukaj]',
    desc: 'Twoja biblioteka gier z bazy (Steam + PSN).',
    status: 'aktywna',
  },
  {
    name: '/antinuke',
    desc: 'Ochrona serwera: status / włącz / progi / whitelist.',
    status: 'aktywna',
  },
  { name: '/link <kod>', desc: 'Łączy konto Discord z profilem GH0ST EMPIRE.', status: 'aktywna' },
  {
    name: '/portal',
    desc: 'Link do portalu GH0ST + jak zarabiać Ghost Tokens.',
    status: 'aktywna',
  },
];
  ...
  return (
    <div className="space-y-6">
      <p className="text-sm text-muted">
        Slash-komendy zarejestrowane przez bota (discord.js v14).
      </p>
      ...
      <p className="text-xs text-muted">
        Część komend (ekonomia GH0ST: GT za czat/voice, `/portal`, `/link`) jest rozwijana w module
        bota.
      </p>
    </div>
  );
