    ...
    <section className="relative h-[72vh] min-h-[480px] w-full">
      ...
      >
        ...
        <p className="mt-3 text-sm text-white/80">
          ...
          {game.playtime_min ? ` · ${hours(game.playtime_min)} ${tt('game.played')}` : ''}
        </p>
        {game.summary && (
        ...
        <div className="mt-6 flex gap-3">
          ...
          <button
            type="button"
            className="rounded bg-white/20 px-7 py-2.5 font-semibold text-white backdrop-blur transition hover:bg-white/30"
          >
            ℹ {tt('hero.moreInfo')}
          </button>
        </div>
