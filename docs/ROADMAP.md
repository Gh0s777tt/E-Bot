...
- 🛒 **Marketplace / efekt sieciowy** — pluginy, multi‑guild jako usługa. *Config* per‑serwer już jest (Etap K). **Decyzje: płatne (tiery) + community (3rd-party)** → pełny zakres M1–M6. **M1 w toku:** schemat danych (v0.267.0) + warstwa multi-tenant [`lib/tenant.ts`](../dashboard/lib/tenant.ts) z owner-bypass + zawężony przełącznik serwerów (v0.268.0); dalej scope per-guild zapytań + onboarding. Plan: [`PLAN-MARKETPLACE.md`](PLAN-MARKETPLACE.md).
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
```
<div align="center"><sub>Ostatnia aktualizacja: 2026‑06‑19 · v0.268.0 (#338) · powiązane: <a href="PHASES.md">PHASES</a> · <a href="../CHANGELOG.md">CHANGELOG</a> · weryfikacja sync: <code>pnpm docs:check</code></sub></div>
