...
- 🛒 **Marketplace / efekt sieciowy** — pluginy, multi‑guild jako usługa. *Config* per‑serwer już jest (Etap K). **Decyzje: płatne (tiery) + community (3rd-party)** → pełny zakres M1–M6. **M1 ✓ · M2 ✓ · M4 rdzeń ✓:** schemat + multi-tenant + chokepoint (v0.267–269) + katalog + strona + toggle per-serwer (v0.270–272) + **self-serve login adminów serwerów** [`lib/enroll.ts`](../dashboard/lib/enroll.ts) (env-gated, zaludnia `guild_members`, v0.273.0); dalej tiery/billing (M5) → community SDK (M6). Plan: [`PLAN-MARKETPLACE.md`](PLAN-MARKETPLACE.md).
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
```
<div align="center"><sub>Ostatnia aktualizacja: 2026‑06‑19 · v0.273.0 (#343) · powiązane: <a href="PHASES.md">PHASES</a> · <a href="../CHANGELOG.md">CHANGELOG</a> · weryfikacja sync: <code>pnpm docs:check</code></sub></div>
