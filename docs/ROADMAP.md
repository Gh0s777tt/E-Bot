...
gantt
  ...
  i18n UI panelu (28/~40 stron)        :active, i3, 2026-06-12, 8d
  section Otwarte
...
| **i18n** | Treść panelu/web w 14 językach: pomoc 37/37 ✓, web ✓, **UI panelu 28/~40** | 🔄 w toku |
...
Tłumaczenie etykiet/formularzy stron ustawień na 14 języków (powłoka + pomoc + web już gotowe). **Zrobione 28/~40 stron**; pozostaje **~10** (`/ai /applications /commands /creator /custom-commands /engagement /moderation /roles /settings /setup`). Szczegóły: [`PHASES.md`](PHASES.md#-bieżący-tor-v02380).
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
```
<div align="center"><sub>Ostatnia aktualizacja: 2026‑06‑19 · v0.238.0 (#308) · powiązane: <a href="PHASES.md">PHASES</a> · <a href="../CHANGELOG.md">CHANGELOG</a> · weryfikacja sync: <code>pnpm docs:check</code></sub></div>
