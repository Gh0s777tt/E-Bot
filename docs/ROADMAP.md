...
- 🛒 **Marketplace / efekt sieciowy** — pluginy, multi‑guild jako usługa. *Config* per‑serwer już jest (Etap K). **Decyzje: płatne (tiery) + community (3rd-party)** → pełny zakres M1–M6. **M1 ✓ · M2 ✓ · M4 rdzeń ✓ · M5 ✓:** schemat + multi-tenant + chokepoint (v0.267–269) + katalog + strona + toggle (v0.270–272) + self-serve login (v0.273.0) + tiery + **billing Stripe** [`lib/billing.ts`](../dashboard/lib/billing.ts) (Checkout + webhook, env-gated, v0.274–275; [`AKTYWACJA-STRIPE.md`](AKTYWACJA-STRIPE.md)); zostaje **M6 — community SDK/sandbox/review**. Plan: [`PLAN-MARKETPLACE.md`](PLAN-MARKETPLACE.md).
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
```
<div align="center"><sub>Ostatnia aktualizacja: 2026‑06‑19 · v0.275.0 (#345) · powiązane: <a href="PHASES.md">PHASES</a> · <a href="../CHANGELOG.md">CHANGELOG</a> · weryfikacja sync: <code>pnpm docs:check</code></sub></div>
