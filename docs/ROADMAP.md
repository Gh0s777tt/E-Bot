...
gantt
  ...
  i18n UI panelu (31/~40 stron)        :active, i3, 2026-06-12, 8d
  section Otwarte
...
| **i18n** | Treść panelu/web w 14 językach: pomoc 37/37 ✓, web ✓, **UI panelu 31/~40** | 🔄 w toku |
...
Tłumaczenie etykiet/formularzy stron ustawień na 14 języków (powłoka + pomoc + web już gotowe). **Zrobione 31/~40 stron**; pozostaje **~7** (`/ai /applications /custom-commands /engagement /moderation /settings /setup`). Szczegóły: [`PHASES.md`](PHASES.md#-bieżący-tor-v02410).
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
```
<div align="center"><sub>Ostatnia aktualizacja: 2026‑06‑19 · v0.241.0 (#311) · powiązane: <a href="PHASES.md">PHASES</a> · <a href="../CHANGELOG.md">CHANGELOG</a> · weryfikacja sync: <code>pnpm docs:check</code></sub></div>
