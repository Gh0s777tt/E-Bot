...
- 🛒 **Marketplace / efekt sieciowy** — pluginy, multi‑guild jako usługa. *Config* per‑serwer już jest (Etap K). **Decyzje: płatne (tiery) + community (3rd-party)** → pełny zakres M1–M6. **M1 rdzeń ✓ + M2 ✓ (first-party):** schemat (v0.267.0) + multi-tenant (v0.268.0) + chokepoint (v0.269.0) + katalog (v0.270.0) + strona `/marketplace` (v0.271.0) + **interaktywny toggle per-serwer** [`MarketplaceGrid`](../dashboard/components/MarketplaceGrid.tsx) (v0.272.0); dalej onboarding (M4) → tiery/billing (M5) → community SDK (M6). Plan: [`PLAN-MARKETPLACE.md`](PLAN-MARKETPLACE.md).
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
```
<div align="center"><sub>Ostatnia aktualizacja: 2026‑06‑19 · v0.272.0 (#342) · powiązane: <a href="PHASES.md">PHASES</a> · <a href="../CHANGELOG.md">CHANGELOG</a> · weryfikacja sync: <code>pnpm docs:check</code></sub></div>
