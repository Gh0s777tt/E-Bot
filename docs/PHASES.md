<!-- SYNC: v0.275.0 · #345 · 2026-06-19 — utrzymywane przez `pnpm docs:check` (NIE edytuj ręcznie wersji bez aktualizacji statusu) -->
<div align="center">
...
- [ ] **Marketplace pluginów / multi-guild — 🚧 M1 ✓ · M2 ✓ · M4 rdzeń ✓ · M5 ✓** — decyzje: ✅ **płatne** (tiery) + ✅ **community** (3rd-party) → pełny zakres **M1–M6**. **Zrobione:** schemat + multi-tenant + chokepoint izolacji (v0.267–269) + katalog + strona `/marketplace` + toggle per-serwer (v0.270–272) + self-serve login [`lib/enroll.ts`](../dashboard/lib/enroll.ts) (v0.273.0) + tiery/gating [`lib/billing.ts`](../dashboard/lib/billing.ts) (v0.274.0) + **billing Stripe** (Checkout + webhook + przycisk Premium, env-gated, v0.275.0; [`AKTYWACJA-STRIPE.md`](AKTYWACJA-STRIPE.md)). Dalej: **M6 — community pluginy** (SDK/sandbox/review). Plan: [`PLAN-MARKETPLACE.md`](PLAN-MARKETPLACE.md)
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
```
<div align="center"><sub>Ostatnia aktualizacja: 2026‑06‑19 · v0.275.0 (#345) · powiązane: <a href="ROADMAP.md">ROADMAP</a> · <a href="../CHANGELOG.md">CHANGELOG</a> · weryfikacja sync: <code>pnpm docs:check</code></sub></div>
