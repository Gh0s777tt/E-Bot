<!-- SYNC: v0.271.0 · #341 · 2026-06-19 — utrzymywane przez `pnpm docs:check` (NIE edytuj ręcznie wersji bez aktualizacji statusu) -->
<div align="center">
...
- [ ] **Marketplace pluginów / multi-guild — 🚧 M1 rdzeń ✓, M2 w toku** — decyzje: ✅ **płatne** (tiery) + ✅ **community** (3rd-party) → pełny zakres **M1–M6**. **Zrobione:** schemat danych (v0.267.0) + warstwa multi-tenant [`lib/tenant.ts`](../dashboard/lib/tenant.ts) (v0.268.0) + chokepoint dostępu w `getPrimaryGuildId` (v0.269.0) + katalog pluginów [`lib/pluginCatalog.ts`](../dashboard/lib/pluginCatalog.ts) (first-party z kodu + community z DB, v0.270.0) + **strona `/marketplace`** [`app/marketplace/page.tsx`](../dashboard/app/marketplace/page.tsx) (karty katalogu + nav, v0.271.0). Dalej: toggle enable per-serwer + onboarding (M4). Plan: [`PLAN-MARKETPLACE.md`](PLAN-MARKETPLACE.md)
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
```
<div align="center"><sub>Ostatnia aktualizacja: 2026‑06‑19 · v0.271.0 (#341) · powiązane: <a href="ROADMAP.md">ROADMAP</a> · <a href="../CHANGELOG.md">CHANGELOG</a> · weryfikacja sync: <code>pnpm docs:check</code></sub></div>
