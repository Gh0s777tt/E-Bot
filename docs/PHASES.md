...
- [ ] **Marketplace pluginów / multi-guild — 🚧 M1 W TOKU** — decyzje podjęte: ✅ **płatne** (tiery free/premium) + ✅ **community** (3rd-party) → pełny zakres **M1–M6**. **M1 start (v0.267.0):** schemat danych [`m1-marketplace-schema.sql`](../dashboard/scripts/m1-marketplace-schema.sql) (additive: `guilds`/`guild_members`/`plugins`/`guild_plugins`/`plugin_config`). Dalej: multi-tenant auth (OAuth gildii usera + scope per-guild). Plan: [`PLAN-MARKETPLACE.md`](PLAN-MARKETPLACE.md)
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
```
<div align="center"><sub>Ostatnia aktualizacja: 2026‑06‑19 · v0.267.0 (#337) · powiązane: <a href="ROADMAP.md">ROADMAP</a> · <a href="../CHANGELOG.md">CHANGELOG</a> · weryfikacja sync: <code>pnpm docs:check</code></sub></div>
