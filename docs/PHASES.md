<!-- SYNC: v0.270.0 · #340 · 2026-06-19 — utrzymywane przez `pnpm docs:check` (NIE edytuj ręcznie wersji bez aktualizacji statusu) -->
<div align="center">
...
- [ ] **Marketplace pluginów / multi-guild — 🚧 M1 rdzeń ✓, M2 w toku** — decyzje: ✅ **płatne** (tiery) + ✅ **community** (3rd-party) → pełny zakres **M1–M6**. **Zrobione:** schemat danych [`m1-marketplace-schema.sql`](../dashboard/scripts/m1-marketplace-schema.sql) (v0.267.0) + warstwa multi-tenant [`lib/tenant.ts`](../dashboard/lib/tenant.ts) (v0.268.0) + chokepoint dostępu w `getPrimaryGuildId` (odczyt/zapis per-guild, v0.269.0) + **katalog pluginów** [`lib/pluginCatalog.ts`](../dashboard/lib/pluginCatalog.ts) (first-party z kodu + community z DB, v0.270.0). Dalej: UI marketplace (M2) + onboarding (M4). Plan: [`PLAN-MARKETPLACE.md`](PLAN-MARKETPLACE.md)
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
```
<div align="center"><sub>Ostatnia aktualizacja: 2026‑06‑19 · v0.270.0 (#340) · powiązane: <a href="ROADMAP.md">ROADMAP</a> · <a href="../CHANGELOG.md">CHANGELOG</a> · weryfikacja sync: <code>pnpm docs:check</code></sub></div>
