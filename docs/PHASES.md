...
- [ ] **Pełne lustrzane RTL** — fundament `dir="rtl"` gotowy (v0.254.0); pozostaje zamiana fizycznych klas Tailwind (`ml-`/`pl-`/`left-`/`text-left`) na logiczne (`ms-`/`ps-`/`start`/`text-start`) w ~100 komponentach
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
```
<div align="center"><sub>Ostatnia aktualizacja: 2026‑06‑19 · v0.254.0 (#324) · powiązane: <a href="ROADMAP.md">ROADMAP</a> · <a href="../CHANGELOG.md">CHANGELOG</a> · weryfikacja sync: <code>pnpm docs:check</code></sub></div>
