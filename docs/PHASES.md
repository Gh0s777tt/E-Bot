<!-- SYNC: v0.272.0 · #342 · 2026-06-19 — utrzymywane przez `pnpm docs:check` (NIE edytuj ręcznie wersji bez aktualizacji statusu) -->
<div align="center">
...
- [ ] **Marketplace pluginów / multi-guild — 🚧 M1 rdzeń ✓, M2 ✓ (first-party)** — decyzje: ✅ **płatne** (tiery) + ✅ **community** (3rd-party) → pełny zakres **M1–M6**. **Zrobione:** schemat danych (v0.267.0) + warstwa multi-tenant [`lib/tenant.ts`](../dashboard/lib/tenant.ts) (v0.268.0) + chokepoint dostępu w `getPrimaryGuildId` (v0.269.0) + katalog [`lib/pluginCatalog.ts`](../dashboard/lib/pluginCatalog.ts) (first-party z kodu + community z DB, v0.270.0) + strona `/marketplace` (v0.271.0) + **interaktywny toggle enable/disable per-serwer** [`MarketplaceGrid`](../dashboard/components/MarketplaceGrid.tsx) (first-party przez `/api/modules`; community do M6, v0.272.0). Dalej: onboarding self-serve (M4) → tiery/billing (M5) → community SDK (M6). Plan: [`PLAN-MARKETPLACE.md`](PLAN-MARKETPLACE.md)
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
```
<div align="center"><sub>Ostatnia aktualizacja: 2026‑06‑19 · v0.272.0 (#342) · powiązane: <a href="ROADMAP.md">ROADMAP</a> · <a href="../CHANGELOG.md">CHANGELOG</a> · weryfikacja sync: <code>pnpm docs:check</code></sub></div>
