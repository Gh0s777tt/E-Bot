<!-- SYNC: v0.268.0 · #338 · 2026-06-19 — utrzymywane przez `pnpm docs:check` (NIE edytuj ręcznie wersji bez aktualizacji statusu) -->
<div align="center">
...
- [ ] **Marketplace pluginów / multi-guild — 🚧 M1 W TOKU** — decyzje: ✅ **płatne** (tiery) + ✅ **community** (3rd-party) → pełny zakres **M1–M6**. **Zrobione:** schemat danych [`m1-marketplace-schema.sql`](../dashboard/scripts/m1-marketplace-schema.sql) (v0.267.0) + **warstwa multi-tenant** [`lib/tenant.ts`](../dashboard/lib/tenant.ts) (dostęp per-guild, owner-bypass) + zawężenie przełącznika serwerów do dostępnych (v0.268.0). Dalej: scope zapytań/akcji per-guild + onboarding (M4). Plan: [`PLAN-MARKETPLACE.md`](PLAN-MARKETPLACE.md)
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
```
<div align="center"><sub>Ostatnia aktualizacja: 2026‑06‑19 · v0.268.0 (#338) · powiązane: <a href="ROADMAP.md">ROADMAP</a> · <a href="../CHANGELOG.md">CHANGELOG</a> · weryfikacja sync: <code>pnpm docs:check</code></sub></div>
